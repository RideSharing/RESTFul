...
define('ITINERARY_STATUS_ONGOING', 5);//driver accept
...
define('USER_CREATED_MESSAGE_SUCCESSFULLY', 31);
define('USER_CREATE_MESSAGE_FAILED', 32);
define('EMAIL_NOT_EXIST', 33);
